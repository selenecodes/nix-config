    ...
    imports = [
      {
        ...
        programs.bifrost.package = bifrostHttp;
        programs.bifrost.settings = {
          "$schema" = "https://www.getbifrost.ai/schema";
          providers.azure.keys = [
            {
              name = "azure-default-credential";
              value = "";
              models = ["gpt-5.1" "gpt-5.4" "gpt-5.5" "gpt-5.6-luna" "gpt-5.6-sol" "gpt-5.6-terra" "text-embedding-3-large"];
              weight = 1.0;
              aliases = {
                "gpt-5.1" = "gpt-5.1";
                "gpt-5.4" = "gpt-5.4";
